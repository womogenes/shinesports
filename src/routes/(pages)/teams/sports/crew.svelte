...
<div class="w-full flex justify-center items-center flex-col">
    ...
    <div class="w-full max-w-4xl m-10">
        ...
        <p class="text-white">Showing {filteredTeams.length} of {allTeams.length} total teams</p>
        </div>
        ...
        <div class="flex w-full flex-col gap-4">
            ...
            {:else}
            <p class="text-white" in:fade>No teams match your filters ☹️ Try loosening them.</p>
            {/each}
        </div>
        </div>
    </div>
